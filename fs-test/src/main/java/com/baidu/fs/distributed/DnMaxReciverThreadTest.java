...
import com.baidu.fs.parallel.ParallelSlowReader;
...
public class DnMaxReciverThreadTest {
    private static final Logger LOG = LoggerFactory.getLogger(DnMaxReciverThreadTest.class);
    ...
    private void runTests() throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, "Dn Max Receiver Thread Test");

        job.setJarByClass(DnMaxReciverThreadTest.class);
    ...
    public static void main(String[] args) throws Exception {
        new DnMaxReciverThreadTest().run(args);
    }
}
