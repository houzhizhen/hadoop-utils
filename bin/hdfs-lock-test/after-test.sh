...
curl http://xafj-sys-rpm23qygubp.xafj.baidu.com:8075/conf > ${TAG}/${TIME_SUFFIX}-dn-rpm23qygubp-conf.xml 2>/dev/null
curl http://xafj-sys-rpm14usp6bo.xafj.baidu.com:8075/conf > ${TAG}/${TIME_SUFFIX}-dn-rpm14usp6bo-conf.xml 2>/dev/null
curl http://xafj-sys-rpm723xv2lg.xafj.baidu.com:8075/conf > ${TAG}/${TIME_SUFFIX}-dn-rpm723xv2lg-conf.xml 2>/dev/null
curl http://xafj-sys-rpm58y98bhi.xafj.baidu.com:8070/conf > ${TAG}/${TIME_SUFFIX}-nn-rpm58y98bhi-conf.xml 2>/dev/null
